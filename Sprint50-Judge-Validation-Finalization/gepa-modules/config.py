...
localJudge_qwen3 = LocalJudgeModel(
...
def local_judge_qwen3(english, translated, direction):
    result = localJudge_qwen3.evaluate(english=english, mandarin=translated)  # or cantonese=
...
JUDGE_CONFIGS = [
    JudgeConfig(
        ...
        num_runs=3,
        notes="Local Qwen2.5-7B-Instruct backend",
    ),
    JudgeConfig(
        name="local_qwen3_gemba_rrwa",
        judge_fn=local_judge_qwen3,
        num_runs=3,
